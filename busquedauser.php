     ...
     <div id="content">
       ...
       // $col = pg_fetch_all_columns($result);
		while($col = pg_fetch_assoc($result)){
			 echo "<a href='http://localhost/RS/detalleusuarioadmin.php?nombre=" . $col['nombre'] . "&id=".$col['id']. "&apellido=".$col['apellido']. "&email=".$col['email']."'>" . $col['nombre'] ." ".$col['apellido']. " - ".$col['email']. "</a><br>";		
		}
      ?>    
